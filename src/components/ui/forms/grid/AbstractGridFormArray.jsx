...
export default function AbstractGridFormArray({
  ...
  return <Component field={field} append={append} level={level} hideAddButton={hideAddButton} templates={templates} controlMessages={controlMessages}>{children}</Component>;
}

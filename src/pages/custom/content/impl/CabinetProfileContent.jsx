...
export default function CabinetProfileContent({ data, context }) {
  ...
  const formFields = [
    ...
    {
      key: "array1",
      label: "Пример массива",
      type: "array",
      cols: 4,
      maxItems: 2,
      add_element_message: "Добавить скил",
      fields: [
        {
          key: "arr1",
          placeholder: "Имя",
  ...
  const handleOrgProfileEdit = function () {
    const loadFields = async function () {
      ...
      return translateDeep(
        ...
        modifyFormField(data.forms.org_profile.fields, "orgType", {
          options: orgTypes,
        }),
        t
      );
    ...
    <>
      <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <AbstractCard
          ...
          buttons={[
            {
              onClick: handleOrgProfileEdit,
              prefix: "Редактировать",
              icon: faEdit,
            },
          ]}
        >
